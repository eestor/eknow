package com.ibm.ph.eknowvation.config;

import com.ibm.ph.eknowvation.config.oauth2.MongoDBApprovalStore;
import com.ibm.ph.eknowvation.config.oauth2.MongoDBAuthorizationCodeServices;
import com.ibm.ph.eknowvation.config.oauth2.MongoDBClientDetailsService;
import com.ibm.ph.eknowvation.config.oauth2.MongoDBTokenStore;
import com.ibm.ph.eknowvation.repository.*;
...
public class OAuth2ServerConfiguration {
    ...
    protected static class ResourceServerConfiguration extends ResourceServerConfigurerAdapter {
        ...
        public void configure(ResourceServerSecurityConfigurer resources) throws Exception {
            resources.resourceId("res_eknow").tokenStore(tokenStore);
        }
    }
