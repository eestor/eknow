package com.ibm.ph.eknowvation.config.dbmigrations;
...
public class InitialSetupMigration {
    ...
    public void addOAuthClientDetails(MongoTemplate mongoTemplate) {
        ...
        appDetails.setClientId("eknowapp");
        appDetails.setClientSecret("my-secret-token-to-change-in-production");
        appDetails.setResourceIds(Collections.singletonList("res_eknow"));
        ...
        swaggerUIDetails.setResourceIds(Collections.singletonList("res_eknow"));
